  ...
  return <Wrapper centerChildContent={true} columnChildContent={true}>
    <Container>
      <Headline>
        ...
        <h5>
          VoteByMail.io simplifies the state <VbmWording adjective/> signup process.
        </h5>
      </Headline>
      ...
      <Steps>
        <Col md={4} sm={12}>
          ...
          <h5>1. Sign up</h5>
          <p>Sign up below for <VbmWording noun/>.  The application is sent to your election official.</p>
        </Col>
        <Col md={4} sm={12}>
          <div className="imgWrapper">
